...
from src.extra.entities.response.exceptions.server import ServerExceptionsEnum
...
def add_logs(app: FastAPI):
    ...
    async def simple_logs(request: Request, call_next):
        ...
        try:
            ...
            response = JSONResponse(content={'detail': ServerExceptionsEnum.UNKNOWN_SERVER_ERROR.detail},
