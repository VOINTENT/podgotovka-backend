...
@lessons_router.get('/my', response_model=LessonSimpleListWithCountsResponse)
async def get_my_lessons(account_student: AccountStudent = Depends(get_current_account_student),
