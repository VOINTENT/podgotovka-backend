...
@homeworks_router.get('/{homework_id}/with-results', response_model=HomeworkDetailWithResultsResponse)
async def get_homework_detail_for_student(
    ...
    homework = await HomeworkService.get_homework_detail_for_student(homework_id, current_account_student.id)
