...
from src.internal.biz.creators.response.lesson_simple_watched import LessonSimpleWatchedResponseCreator
...
class LessonSimpleWatchedListWithCountsResponseCreator(Creator):
    @staticmethod
    def get_from_lessons_with_counts(lessons_with_counts: LessonsWithCounts) -> LessonSimpleListWithCountsResponse:
        return LessonSimpleListWithCountsResponse(
            lessons=LessonSimpleWatchedResponseCreator.get_many_from_lessons(lessons_with_counts.lessons),
